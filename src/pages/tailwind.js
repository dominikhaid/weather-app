            ...
            <div className="flex flex-col flex-grow bg-white lg:shadow-2xl lg:rounded-lg lg:overflow-hidden">
              <div className="flex-grow flex flex-col justify-center p-12">
                ...
                <div className="md:pl-16 pl-0">
                  <h1 className="sm:font-light text-2xl sm:text-3xl md:text-4xl text-gray-900 mt-6">
                    Welcome to your first Tailwind project!
                  </h1>
                  <p className="sm:text-xl text-gray-600 mt-3 leading-relaxed">
                    The file you're looking at is the{' '}
                    <span className="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded">
                      index.html
                    </span>{' '}
                    ...
                    <div className="flex flex-grow">
                      <div>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          className="h-8 w-8 md:h-10 md:w-10 md:-my-1"
                        >
                          <g>
                            <path
